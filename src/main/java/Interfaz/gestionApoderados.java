 ...
 * @author black
 */
public class gestionApoderados extends javax.swing.JFrame {

    /**
     * Creates new form gestionApoderados
     */
    public gestionApoderados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestion Apoderados");
    ...
    private ApoderadoDAO apoDAO = new ApoderadoDAO();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            apoDAO.eliminarApoderado(id);
            
        } catch (Exception ex) {
            Logger.getLogger(gestionApoderados.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            apoDAO.actualizarApoderado(apoderado);
    ...
    public void actualizarTabla(){
        ...
        try {
            apoderados = apoDAO.buscarApoderadoPorNombre("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gestionApoderados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gestionApoderados().setVisible(true);
            }
        });
