 ...
 * @author black
 */
public class InsertApoderado extends javax.swing.JFrame {

    /**
     * Creates new form InsertApoderado
     */
    public InsertApoderado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertApoderado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertApoderado().setVisible(true);
            }
        });
    }
